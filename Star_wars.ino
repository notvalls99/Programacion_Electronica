...
int f=349; // Fa
int g=391; // Sol
int gS=415; // Sol sostenido
int a=440; // La
int aS=455; // La sostenido
int b=466; // Si
int cH=523; // Do escala superior
int cSH=554; // Di sostenido escala superior 
int dH=587; // Re escala superior
int dSH=622; // Re sostenido escala superior
int eH=659; // Mi escala superior
int fH=698; // Fa escala superior
int fSH=740; // Fa sostenido escala superior
int gH=783; // Sol escala superior
int gSH=830; // Sol sostenido escala superior
int aH=880; // La escala superior
 ...
 */
    ...
    delay(3000);  // tres segundos para volver a empezar.
}
